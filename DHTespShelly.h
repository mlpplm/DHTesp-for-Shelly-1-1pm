/*Modified library for Shelly 1/1pm Switch by mlpplm
...
public:
  ...
  void setup(uint8_t dhtPinin, uint8_t dhtPinout) __attribute__((deprecated));
  void setup(uint8_t pinin, uint8_t pinout, DHT_MODEL_t model=AUTO_DETECT);
  void resetTimer();
