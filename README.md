Shelly 1/1PM version of DHTesp library. The Rx/Tx pin has been split into Rx and Tx pins due to Shelly 1/1PM Temperature addon. The reason is that this addon uses directional opto-isolators in order to isolate the high voltage and small signal sections.

USAGE: dht.setup(<dht22_pinin>, <dht22_pinout>, DHTesp::DHT22); instead of dht.setup(<dht22_pin>, DHTesp::DHT22);
